...
def rating_analysis(request):
    ...
    #client = language.LanguageServiceClient.from_service_account_json('static/sent.json')
    #document = language.Document(content=comment, type_=language.Document.Type.PLAIN_TEXT)
    #sentiment = client.analyze_sentiment(request={'document': document}).document_sentiment

    client = language_v1.LanguageServiceClient.from_service_account_json('static/sent.json')
